...
/**
 * Variables in s are sorted in non increasing order. 
 */

public class MSortDecreasing extends MSort implements ConstraintI {

	public MSortDecreasing(VarI[] x, VarI[] s, double epsilon) {
	...
	public MSortDecreasing(VarI[] x, VarI[] s, MIntVar[] p, double epsilon) { // Permits re-using the permutation 
		this(x,s,epsilon);
		this.p = p;
	}

	public MSortDecreasing(MMathIntVar[] x, MMathIntVar[] s) { // Integer case
		this(x,s,1);
	}

	public MSortDecreasing(MMathIntVar[] x, MIntVar[]p, MMathIntVar[] s) { // Integer case
