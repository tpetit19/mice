 ...
 * Every start time of two activities must be separated by 300 units of time
 */

public class CumulativeElKholi3 {
	...
	public static String model(int seed, String system) {
		...
		MMathIntVar z = new MMathIntVar(200,200,solver);
		solver.add(MathVarConstraintFactory.interdistance(start, z));
